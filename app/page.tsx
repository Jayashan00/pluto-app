    ...
    <div className="bg-white min-h-screen overflow-x-hidden">
      ...
      <section className="relative w-full overflow-hidden bg-[#11173E]" style={{ minHeight: "420px" }}>
        ...
        <div className="hidden lg:block relative z-10 px-16 py-12" style={{ minHeight: "500px" }}>
          ...
          <motion.img
            ...
            src="/LapMockup.png" alt="laptop" className="absolute top-10 left-[24%] w-[48%] z-20"
          />

          <motion.img
            animate={float}
            src="/PhoneMockup.png" alt="phone" className="absolute top-10 right-[16%] w-[10%] z-30 cursor-pointer"
          />
          ...
          >
            <motion.div whileHover={{ scale: 1.1 }} whileTap={{ scale: 0.95 }} className="w-12 h-12 bg-[#2431DF] rounded-full flex items-center justify-center cursor-pointer shadow-lg">
      ...
      <div className="relative">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 py-8">
          ...
          <motion.div id="terminal" variants={fadeUp} initial="hidden" whileInView="visible" viewport={{ once: true }} className="w-full max-w-2xl mx-auto mt-20 relative">
